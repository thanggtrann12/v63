...
void PnpBGTaskFn(void *argument)
{
	...
	//			pnp_data_table_t pnp_opti_xz;	
			...
			uint16_t opti_loc_x1 = 0, opti_loc_y1 = 0, opti_loc_z1 = 0;
			...
			uint16_t opti_loc_x2 = 0, opti_loc_y2 = 0, opti_loc_z2 = 0, opti_loc_x3 = 0, opti_loc_y3 = 0, opti_loc_z3 = 0;//, opti_loc_xz = 0;
			float alpha_x2_temp = 0, alpha_y2_temp = 0, alpha_z2_temp = 0, alpha_x3_temp = 0, alpha_y3_temp = 0, alpha_z3_temp = 0;
#endif

			pnp_background(sq_data->x1, ACTUAL_DATA_LEN, avgsq_noise_x, false, &pnp_opti_x1, &opti_loc_x1, &good_found_x1,  &flag_lowsig_x1);
			pnp_background(sq_data->y1, ACTUAL_DATA_LEN, avgsq_noise_y, false, &pnp_opti_y1, &opti_loc_y1, &good_found_y1,  &flag_lowsig_y1);
			pnp_background(sq_data->z1, ACTUAL_DATA_LEN, avgsq_noise_z, false, &pnp_opti_z1, &opti_loc_z1, &good_found_z1,  &flag_lowsig_z1);
#ifdef PAD_3_SENSOR
			pnp_background(sq_data->x2, ACTUAL_DATA_LEN, avgsq_noise_x, false, &pnp_opti_x2, &opti_loc_x2, &good_found_x2,  &flag_lowsig_x2);
			pnp_background(sq_data->y2, ACTUAL_DATA_LEN, avgsq_noise_y, false, &pnp_opti_y2, &opti_loc_y2, &good_found_y2,  &flag_lowsig_y2);
			pnp_background(sq_data->z2, ACTUAL_DATA_LEN, avgsq_noise_z, false, &pnp_opti_z2, &opti_loc_z2, &good_found_z2,  &flag_lowsig_z2);
			pnp_background(sq_data->x3, ACTUAL_DATA_LEN, avgsq_noise_x, false, &pnp_opti_x3, &opti_loc_x3, &good_found_x3,  &flag_lowsig_x3);
			pnp_background(sq_data->y3, ACTUAL_DATA_LEN, avgsq_noise_y, false, &pnp_opti_y3, &opti_loc_y3, &good_found_y3,  &flag_lowsig_y3);
			pnp_background(sq_data->z3, ACTUAL_DATA_LEN, avgsq_noise_z, false, &pnp_opti_z3, &opti_loc_z3, &good_found_z3,  &flag_lowsig_z3);	
#endif
#ifdef PAD_3_SENSOR
			if(alpha_x1 == 0 && alpha_y1 == 0 && alpha_z1 == 0 && alpha_x2 == 0 && alpha_y2 == 0 && alpha_z2 == 0 && alpha_x3 == 0 && alpha_y3 == 0 && alpha_z3 == 0)
			{
				alpha_x1 = 1;
				alpha_y1 = 1;
				alpha_z1 = 1;
			...
			pnp_background(sum_data_bpf, ACTUAL_DATA_LEN, avgsq_noise_xyz, true, &pnp_opti_xz, &opti_loc_xz, &good_found_xz,  &flag_lowsig_xz);
			...
			dev_params.PnpBgRatio1.X = alpha_x1_temp;
			dev_params.PnpBgRatio1.Y = alpha_y1_temp;
			dev_params.PnpBgRatio1.Z = alpha_z1_temp;
#ifdef PAD_3_SENSOR
			dev_params.PnpBgRatio2.X = alpha_x2_temp;
			dev_params.PnpBgRatio2.Y = alpha_y2_temp;
			dev_params.PnpBgRatio2.Z = alpha_z2_temp;
			dev_params.PnpBgRatio3.X = alpha_x3_temp;
			dev_params.PnpBgRatio3.Y = alpha_y3_temp;
			dev_params.PnpBgRatio3.Z = alpha_z3_temp;
#endif
			dev_params.AvgPksOpti1.X = round(pnp_opti_x1.avg_pks);
			dev_params.AvgPksOpti1.Y = round(pnp_opti_y1.avg_pks);
			dev_params.AvgPksOpti1.Z = round(pnp_opti_z1.avg_pks);
#ifdef PAD_3_SENSOR
			dev_params.AvgPksOpti2.X = round(pnp_opti_x2.avg_pks);
			dev_params.AvgPksOpti2.Y = round(pnp_opti_y2.avg_pks);
			dev_params.AvgPksOpti2.Z = round(pnp_opti_z2.avg_pks);
			dev_params.AvgPksOpti3.X = round(pnp_opti_x3.avg_pks);
			dev_params.AvgPksOpti3.Y = round(pnp_opti_y3.avg_pks);
			dev_params.AvgPksOpti3.Z = round(pnp_opti_z3.avg_pks);
#endif
			if(good_found_xz){
